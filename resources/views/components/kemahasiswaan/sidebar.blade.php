...
<aside id="sidebar" class="sidebar kemahasiswaan-sidebar" aria-hidden="false">
    ...
    <nav class="sidebar-nav">
        <ul>
            <li>
                <a href="/portal/kemahasiswaan" class="nav-link {{ request()->is('portal/kemahasiswaan') ? 'active' : '' }}" data-close>
            ...
            <li>
                <a href="/portal/kemahasiswaan/organisasi" class="nav-link {{ request()->is('portal/kemahasiswaan/organisasi') ? 'active' : '' }}" data-close>
                    <span class="nav-icon" aria-hidden="true">
            ...
            <li>
                <a href="/portal/kemahasiswaan/pengajuan" class="nav-link {{ request()->is('portal/kemahasiswaan/pengajuan') ? 'active' : '' }}" data-close>
                    <span class="nav-icon" aria-hidden="true">
            ...
            <li>
                <a href="/portal/kemahasiswaan/pengumuman" class="nav-link {{ request()->is('portal/kemahasiswaan/pengumuman') ? 'active' : '' }}" data-close>
                    <span class="nav-icon" aria-hidden="true">
            ...
            <li>
                <a href="/portal/kemahasiswaan/notifikasi" class="nav-link {{ request()->is('portal/kemahasiswaan/notifikasi') ? 'active' : '' }}" data-close>
                    <span class="nav-icon" aria-hidden="true">
