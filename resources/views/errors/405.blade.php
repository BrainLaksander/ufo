...
<body>
    ...
    <div class="login-container">
        <div class="login-header">
            <h2>405</h2>
            <p>Metode Tidak Diizinkan</p>
        </div>

        <div class="error-message">
            Metode permintaan HTTP (seperti GET atau POST) tidak diizinkan untuk alamat ini. Pastikan Anda mengakses URL melalui tombol atau form yang sesuai.
        </div>
        ...
        <div class="login-footer">
            <button type="button" onclick="history.back()" class="back-link" style="background: none; border: none; cursor: pointer; font-family: inherit;">Kembali ke halaman sebelumnya</button>
        </div>
    </div>
</body>
</html>
