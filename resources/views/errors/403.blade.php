...
<body>
    ...
    <div class="login-container">
        ...
        <div class="error-message">
            Anda tidak memiliki izin (hak akses) untuk membuka halaman ini atau melakukan aksi tersebut. Silakan hubungi administrator jika Anda merasa ini adalah sebuah kesalahan.
        </div>
