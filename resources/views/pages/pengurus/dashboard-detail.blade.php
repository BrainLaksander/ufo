...
<div class="row g-3 mb-4">
    ...
    <div class="col-md-6 col-lg-4">
        <div class="bg-white rounded-3 shadow-sm border p-4" style="border: 2px solid #f0f0f0; cursor: pointer; transition: all 0.3s;" onmouseover="this.style.boxShadow='0 8px 20px rgba(102,51,153,0.15)'" onmouseout="this.style.boxShadow='0 2px 8px rgba(0,0,0,0.05)'">
            ...
            @else
                <span class="badge-org warning">⚠️ Belum Lengkap</span>
            ...
            @endif
            <a href="/portal/pengurus/settings" class="btn-primary-org mt-3" style="display: inline-flex; font-size: 12px;">Lengkapi Profil →</a>
        </div>
    </div>
    ...
    <div class="col-md-6 col-lg-4">
        <div class="bg-white rounded-3 shadow-sm border p-4" style="border: 2px solid #f0f0f0; cursor: pointer; transition: all 0.3s;" onmouseover="this.style.boxShadow='0 8px 20px rgba(102,51,153,0.15)'" onmouseout="this.style.boxShadow='0 2px 8px rgba(0,0,0,0.05)'">
            ...
            <a href="/portal/pengurus/events" class="btn-primary-org mt-3" style="display: inline-flex; font-size: 12px;">Kelola Anggota →</a>
        </div>
    </div>
    ...
    <div class="col-md-6 col-lg-4">
        <div class="bg-white rounded-3 shadow-sm border p-4" style="border: 2px solid #f0f0f0; cursor: pointer; transition: all 0.3s;" onmouseover="this.style.boxShadow='0 8px 20px rgba(102,51,153,0.15)'" onmouseout="this.style.boxShadow='0 2px 8px rgba(0,0,0,0.05)'">
            ...
            <a href="/portal/pengurus/events" class="btn-primary-org mt-3" style="display: inline-flex; font-size: 12px;">Lihat Event →</a>
        </div>
    </div>
    ...
    <div class="col-md-6 col-lg-4">
        <div class="bg-white rounded-3 shadow-sm border p-4" style="border: 2px solid #f0f0f0; cursor: pointer; transition: all 0.3s;" onmouseover="this.style.boxShadow='0 8px 20px rgba(102,51,153,0.15)'" onmouseout="this.style.boxShadow='0 2px 8px rgba(0,0,0,0.05)'">
            ...
            <a href="/portal/pengurus/submissions" class="btn-primary-org mt-3" style="display: inline-flex; font-size: 12px;">Lihat Detail →</a>
        </div>
    </div>
    ...
    <div class="col-md-6 col-lg-4">
        <div class="bg-white rounded-3 shadow-sm border p-4" style="border: 2px solid #f0f0f0; cursor: pointer; transition: all 0.3s;" onmouseover="this.style.boxShadow='0 8px 20px rgba(102,51,153,0.15)'" onmouseout="this.style.boxShadow='0 2px 8px rgba(0,0,0,0.05)'">
            ...
            <a href="/portal/pengurus/reports" class="btn-primary-org mt-3" style="display: inline-flex; font-size: 12px;">Lihat Laporan →</a>
        </div>
    </div>
</div>
...
<div class="bg-white rounded-3 shadow-sm border p-4 mb-4" style="border: 2px solid #ffcccc; background: #fffaf5;">
    <h5 class="text-danger mb-3" style="font-weight: 700;">⚠️ Perlu Perhatian Urgent</h5>
                ...
                @forelse($recentActivities as $log)
                    <div class="p-3 rounded-2" style="background: #f9f9f9; border-left: 4px solid var(--primary);">
                        <div style="display: flex; align-items: center; gap: 10px;">
                            <span style="font-size: 24px;">{{ $log->getActivityIcon() }}</span>
                            <div style="flex: 1;">
