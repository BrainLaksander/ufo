            ...
            <tbody>
                ...
                <tr style="border-bottom: 1px solid #f0f0f0;">
                    ...
                    <td style="padding: 15px;">
                        ...
                        @endif
                        <button class="btn btn-sm btn-danger" style="background: var(--danger); color: white; border: none; padding: 6px 12px; border-radius: 6px; cursor: pointer; margin-left: 5px;">🗑️ Hapus</button>
                    </td>
                </tr>
                @endforeach
            </tbody>
