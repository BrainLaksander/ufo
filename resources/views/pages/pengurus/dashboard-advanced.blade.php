...
<div class="row g-3 mb-4">
        ...
        <div class="stat-card">
            ...
            <div style="margin-top: 10px;">
                ...
                <span class="badge-org @if($profileStatus == 'lengkap') success @else warning @endif">
                    @if($profileStatus == 'lengkap')  Lengkap @else  Belum Lengkap @endif
                </span>
            </div>
            <a href="{{ route('portal.pengurus.settings') }}" class="btn-primary-org" style="width: 100%; text-align: center; margin-top: 10px; text-decoration: none; display: block;">Lengkapi Profil →</a>
        </div>
    </div>
    ...
    <div class="col-md-6 col-lg-4">
        <div class="stat-card">
            ...
            <a href="{{ route('portal.pengurus.members') }}" class="btn-secondary-org" style="width: 100%; text-align: center; margin-top: 15px; text-decoration: none; display: block;">Kelola Anggota →</a>
        </div>
    </div>
    ...
    <div class="col-md-6 col-lg-4">
        <div class="stat-card">
            ...
            <a href="{{ route('portal.pengurus.events') }}" class="btn-secondary-org" style="width: 100%; text-align: center; margin-top: 15px; text-decoration: none; display: block;">Lihat Event →</a>
        </div>
    </div>
    ...
    <div class="col-md-6 col-lg-4">
        <div class="stat-card">
            <div class="stat-card-icon"><i class="bi bi-file-earmark-check-fill"></i></div>
            <div class="stat-card-value">{{ $approvedSubmissions }}</div>
            <div class="stat-card-label">Pengajuan Disetujui</div>
            <a href="{{ route('portal.pengurus.proposals') }}" class="btn-secondary-org" style="width: 100%; text-align: center; margin-top: 15px; text-decoration: none; display: block;">Lihat Pengajuan →</a>
        </div>
    </div>
    ...
    <div class="col-md-6 col-lg-4">
        <div class="stat-card">
            <div class="stat-card-icon"><i class="bi bi-send-check-fill"></i></div>
        ...
        <div class="bg-white rounded-3 shadow-sm border p-4 mb-3" style="border: 2px solid #f0f0f0;">
            ...
            <div style="max-height: 400px; overflow-y: auto;">
                ...
                <div style="margin-top: 15px; padding-top: 15px; border-top: 2px solid #f0f0f0;">
                    <h6 style="font-weight: 700; color: var(--danger); font-size: 12px; margin-bottom: 10px;"> TUGAS OTOMATIS SISTEM</h6>
