...
<div class="page-header mb-4">
    <a href="/portal/pengurus/events" class="btn-secondary-org" style="text-decoration: none; margin-bottom: 10px; display: inline-block;">← Kembali ke Daftar Event</a>
    <h1>{{ $event['name'] }}</h1>
...
<div class="row g-3">
    ...
    <div class="col-lg-4">
        <div class="bg-white rounded-3 shadow-sm border p-4" style="border: 2px solid #f0f0f0;">
            <h4 class="text-primary mb-3" style="font-weight: 700;">⚙️ Aksi</h4>
            <div class="d-flex flex-column gap-2">
                <button class="btn-primary-org">✏️ Edit Event</button>
                <button class="btn-secondary-org">🔒 Tutup Pendaftaran</button>
                <button class="btn-secondary-org">📋 Cetak Sertifikat</button>
                <button class="btn-danger-org" style="width: 100%; padding: 10px; margin-top: 10px;">🗑️ Batalkan Event</button>
            </div>
        </div>
    </div>
</div>
