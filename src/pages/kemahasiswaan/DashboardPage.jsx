...
export default function Dashboard() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-[#F4F5F7] p-6 rounded-md space-y-6">
        {/* Statistik Cards */}
              ...
              >
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <p className="text-4xl text-[#3B1C57] font-medium">
                      {stat.value}
                    </p>
                  </div>
                  <div
                    className={`${stat.color} w-12 h-12 flex items-center justify-center rounded-lg shadow-sm`}
                  >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
            ...
            <div className="space-y-3">
              <button className="w-full bg-[#3B1C57] text-white px-4 py-3 rounded-full hover:bg-[#6B4C8A] transition-colors">
                Review Kegiatan
              </button>
              <button className="w-full bg-[#FFCC00] text-[#3B1C57] px-4 py-3 rounded-full hover:bg-[#FFD633] transition-colors">
                Buat Pengumuman
              </button>
            </div>
            ...
            <div className="mt-6 pt-6 border-t border-gray-200">
              ...
              <div className="space-y-3">
                <div className="p-3 bg-[#F4F4F4] rounded-lg">
                  <p className="text-sm text-[#3B1C57]">
