 ...
 */
export default function StudentBurgerMenu({ open, onClose, activeItem = null }) {
        ...
        <>
            ...
            >
                ...
                <div className="student-burger-nav">
                    <ul className="student-burger-list">
                        ...
                        <li className="student-burger-item">
                            ...
                            >
                                <span className="student-burger-icon-item">
                                    👥
                                </span>
                ...
                <div className="student-burger-footer">
                    ...
                    <div className="student-burger-footer-version">
                        Versi 1.0
                    </div>
                </div>
            </nav>
